...
def single_cutter(split_length, path):
    '''
    Arguments: split_length = in seconds (for every music file in the folder.
    Returns: split songs of a single folder to a new location
    '''
    global dest
...
def full_cutter(split_length, path):
    '''
    Arguments: split_length = in seconds 
    Returns: single_cutter function on each directory for the root dir
    '''
